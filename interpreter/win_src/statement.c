...
//if ++elsif
// void *if_add_elsif(IfStatement* ifhead,ElsIfStatement *condition, ElsIfStatement *block) {
...
void *initElsIfStatement(Expression *condition, StatementList *block) {
    ElsIfStatement *eifS = (ElsIfStatement *) malloc(sizeof(IfStatement));
    
    eifS->condition = condition;
    eifS->block = block;
    return  eifS;
    {
        /* code */
...
static void freeElsIfStatement(Statement *_self) {
    ElsIfStatement *self = (ElsIfStatement *) _self;
    del(self->condition);
    if (self->block)
        del(self->block);
...
const static Statement ElsIfExpressionBase = {executeElsIfStatement, freeElsIfStatement};
/*for statement */
