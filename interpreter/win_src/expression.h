...
typedef struct idExpressionTag idExpression;
typedef struct eee VariableExpression;
...
struct idExpressionTag {
    char *id;
    void (*free)(idExpression *self);

    Value (*evaluate)(idExpression *self, Environment *env);
